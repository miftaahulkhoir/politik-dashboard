  ...
  return (
    <>
      <Row>
        <Col span={15}>
          <Space direction="horizontal" size="0px">
            ...
            <Typography.Title level={5} style={{ color: "#7287A5" }}>({data?.campaign.status[0] + data.campaign.status.slice(1).toLowerCase() || "-"})</Typography.Title>
          </Space>
        </Col>
      </Row>
      ...
      <Row gutter={18}>
        <Col span={6}>
          <Card noPadding  style={{margin: "10px 0px"}}>
            <AdsCard title={"Tipe Ads"} data={data?.campaign.advertisingChannelType[0] + data?.campaign.advertisingChannelType.slice(1).toLowerCase() || "-"} />
          </Card>
        </Col>
        <Col span={6}>
          <Card noPadding style={{margin: "10px 0px"}}>
        ...
        <Col span={6}>
          <Card noPadding  style={{margin: "10px 0px"}}>
            <AdsCard title={"Budget/Hari"} data={data?.customer.currencyCode + " " + data?.campaignBudget.amountMicros.slice(0, -6) + ".00" || "0.00"} />
          </Card>
        </Col>
        <Col span={6}>
          <Card noPadding  style={{margin: "10px 0px"}}>
      ...
      <Row gutter={18}>
        ...
        <Col span={6}>
          <Card noPadding  style={{margin: "10px 0px"}}>
            <AdsCard title={"Cost/Conv."} data={data?.metrics.costPerConversions || data.customer.currencyCode + "0.00"} />
          </Card>
        </Col>
      </Row>
    </>
